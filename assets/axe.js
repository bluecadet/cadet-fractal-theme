...
(function () {
  ...
  function buildViolation(v) {
    ...
    item.setAttribute('class', "Axe--violation--item Axe--violation--item--".concat(v.impact));
    var title = document.createElement('h3');
    title.setAttribute('class', 'Axe--v-title');
    title.innerHTML = "<span class=\"Axe--v-title--impact\">".concat(v.impact, "</span> ").concat(v.description);
    item.appendChild(title);
    var additional = document.createElement('div');
    additional.setAttribute('class', 'Axe--v-additional'); // let impact = document.createElement('p');
    ...
    var nodesTitle = document.createElement('p');
    nodesTitle.setAttribute('class', 'Axe--v-nodes-title');
    nodesTitle.setAttribute('id', 'axe-v-nodes-title');
    nodesTitle.textContent = "Relevant Nodes (".concat(v.nodes.length, "):");
    ...
    v.nodes.forEach(function (n) {
      ...
      nodeHTML.innerHTML = "<span class=\"Axe--v-notice--title\">Source:</span> <span class=\"Axe--v-notice--result\"><pre><code>".concat(escapeHtml(n.html), "</code></pre></span>");
      nodeItem.appendChild(nodeHTML);
      var nodeTarget = document.createElement('div');
      nodeTarget.setAttribute('class', 'Axe--v-notice Axe--v-notice--node-target');
      nodeTarget.innerHTML = "<span class=\"Axe--v-notice--title\">Target:</span> <span class=\"Axe--v-notice--result\"><pre><code>".concat(n.target, "</code></pre></span>");
  ...
  window.addEventListener('previewLoaded', function () {
    var iframe = document.querySelector('.Preview-resizer iframe');
